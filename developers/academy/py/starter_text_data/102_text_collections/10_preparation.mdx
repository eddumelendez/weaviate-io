...
In this section you are going to populate your Weaviate instance with a movie dataset, using the OpenAI API to embed the text data.
...
### <i class="fa-solid fa-chalkboard"></i> OpenAI key

You will need an OpenAI API key to follow along. If you don't have one, go to the [OpenAI website](https://www.openai.com/) and sign up for an account and create an API key.
